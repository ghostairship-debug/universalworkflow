...
def build_effective_config(
    *,
    ...
    config_values = {
        ...
        "adaptive_llm_routing": {
            "enabled": _resolve_value(
                env=environment,
                env_key="WORKFLOW_ADAPTIVE_LLM_ROUTING_ENABLED",
                config=raw_config,
                config_key="adaptive_llm_routing.enabled",
                default=False,
                coerce=_coerce_bool,
            ),
            "simple_model": _resolve_value(
                env=environment,
                env_key="WORKFLOW_ADAPTIVE_SIMPLE_MODEL",
                config=raw_config,
                config_key="adaptive_llm_routing.simple_model",
                default="minimax/MiniMax-M2.7",
                coerce=str,
            ),
            "medium_model": _resolve_value(
                env=environment,
                env_key="WORKFLOW_ADAPTIVE_MEDIUM_MODEL",
                config=raw_config,
                config_key="adaptive_llm_routing.medium_model",
                default="deepseek/deepseek-v4-flash",
                coerce=str,
            ),
            "complex_model": _resolve_value(
                env=environment,
    ...
    effective = {
        ...
        "adaptive_llm_routing": {
            "enabled": config_values["adaptive_llm_routing"]["enabled"].value,
            "enabled_source": config_values["adaptive_llm_routing"]["enabled"].source,
            "simple_model": config_values["adaptive_llm_routing"]["simple_model"].value,
            "simple_model_source": config_values["adaptive_llm_routing"]["simple_model"].source,
            "medium_model": config_values["adaptive_llm_routing"]["medium_model"].value,
            "medium_model_source": config_values["adaptive_llm_routing"]["medium_model"].source,
            "complex_model": config_values["adaptive_llm_routing"]["complex_model"].value,
            "complex_model_source": config_values["adaptive_llm_routing"]["complex_model"].source,
            "coding_adapter": config_values["adaptive_llm_routing"]["coding_adapter"].value,
            "coding_adapter_source": config_values["adaptive_llm_routing"]["coding_adapter"].source,
        },
        "langchain_agent": {
