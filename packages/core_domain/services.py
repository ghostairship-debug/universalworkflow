...
from packages.core_domain.service_inspection import InspectionServiceMixin
...
from packages.core_domain.service_runtime_bundles import RepositoryBundle, WorkerRuntimeBundle
...
class OrchestratorService(
    ...
    def __init__(
        ...
        self.repository_bundle = RepositoryBundle(self.db_path)
        self.repository_bundle.install_on(self)
        self.worker_runtime_bundle = WorkerRuntimeBundle.build(
            effective_config=self.effective_config,
            workspace_root=self._workspace_root(),
            runtime_gateway=runtime_gateway,
            chat_llm_runtime=chat_llm_runtime,
            chat_control_graph=chat_control_graph,
            capability_plane=capability_plane,
            shell_adapter=shell_adapter,
            worker_router=worker_router,
        )
        self.worker_runtime_bundle.install_on(self)
