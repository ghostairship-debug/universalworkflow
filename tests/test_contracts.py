...
def test_m32_interaction_and_cluster_contracts_round_trip() -> None:
    ...
    chat_message = ChatMessage(
        ...
        payload_json={"confirmation": {"action_type": "resume_run", "run_id": "run_123"}},
        provider_message_id="resp_123",
        parent_message_id="chatmsg_parent",
        stream_status="completed",
        graph_node="confirmation_gate",
    ...
    chat_stream_event = ChatStreamEvent(
        ...
        sequence_no=3,
        payload_json={"message_id": chat_message.message_id, "delta": "Confirm"},
    )
